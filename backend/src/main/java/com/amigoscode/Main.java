...
public class Main {
    ...
    private static void testBucketUploadAndDownload(S3Service s3Service, S3Buckets s3Buckets) throws IOException {
        s3Service.putObject(
                s3Buckets.getCustomer(),
                "foo",
                "Hello World".getBytes());
        byte[] obj = s3Service.getObject("fs-mehul-customer-test", "foo");

        System.out.println("Horrayfwfw: " + new String(obj));
    }
